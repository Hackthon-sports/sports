...
const BG_IMAGE_URL =
  "https://cdn.pixabay.com/photo/2016/03/27/19/30/volleyball-1283942_1280.jpg"; // Volleyball image

const matches = [
  {
    id: "1",
    tournamentName: "Volleyball Asia Cup",
  ...
  {
    id: "2",
    tournamentName: "Volleyball World Cup",
  ...
  {
    id: "3",
    tournamentName: "Pro Volleyball League",
    matchName: "Eliminator",
    date: "2025-08-06T19:00:00",
    teamA: "Delhi Spikers",
    teamB: "Mumbai Smashers",
    location: "Mumbai",
    organisation: "PVL",
    isLive: true,
  },
...
// Helper function to format match date/time (same as before)
...
export default function CoachVolleyballUpcoming() {
  ...
  const [formData, setFormData] = useState({
    teamName: "",
    coachName: "",
    players: Array(12).fill(""), // Volleyball usually has 12 players max
  });
  ...
  const handleRegisterSubmit = (tournamentId: string) => {
    ...
    tournament.registeredTeams += 1; // This updates the local array, you may want to sync with backend in real app
  ...
  const renderMatchCard = (item: typeof matches[number]) => (
    <View
      key={item.id}
                ...
                {isOpen && showFormFor === t.id && !isRegistered && (
                  <View className="mt-3 bg-white p-4 rounded-xl shadow">
                    ...
                    <Pressable
                      ...
                      className="bg-orange-500 mt-4 rounded-lg py-3"
                    >
